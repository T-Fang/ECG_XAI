...
class Feature(Enum):
    ...
    RS_RATIO_V5 = 101  # R/S ratio in lead V5
    RS_RATIO_V6 = 102  # R/S ratio in lead V6
    LVH_L1_OLD = 103  # LVH L1 criteria for "old" people (age > 30)
    LVH_L1_YOUNG = 104  # LVH L1 criteria for "young" people (age <= 30)
    LVH_L2_MALE = 105  # LVH L2 criteria for male
    LVH_L2_FEMALE = 106  # LVH L2 criteria for female
    PEAK_R_V1 = 107  # large R wave amplitude in lead V1
    DEEP_S_V5 = 108  # deep S wave in lead V5
    DEEP_S_V6 = 109  # deep S wave in lead V6
    DOM_R_V1 = 110  # dominant R wave in lead V1
    DOM_S_V5 = 111  # dominant S wave in lead V5
    DOM_S_V6 = 112  # dominant S wave in lead V6

    # * Objective features for TModule
    T_AMP_I = 113  # T wave amplitude in lead I
    T_AMP_II = 114  # T wave amplitude in lead II
    T_AMP_V1 = 115  # T wave amplitude in lead V1
    T_AMP_V2 = 116  # T wave amplitude in lead V2
    T_AMP_V3 = 117  # T wave amplitude in lead V3
    T_AMP_V4 = 118  # T wave amplitude in lead V4
    T_AMP_V5 = 119  # T wave amplitude in lead V5
    T_AMP_V6 = 120  # T wave amplitude in lead V6
    INVT_I = 121  # inverted T wave in lead I
    INVT_II = 122  # inverted T wave in lead II
    INVT_V1 = 123  # inverted T wave in lead V1
    INVT_V2 = 124  # inverted T wave in lead V2
    INVT_V3 = 125  # inverted T wave in lead V3
    INVT_V4 = 126  # inverted T wave in lead V4
    INVT_V5 = 127  # inverted T wave in lead V5
    INVT_V6 = 128  # inverted T wave in lead V6

    # * Objective features for AxisModule
    QRS_SUM_I = 129  # sum/integral of QRS complex in lead I
    QRS_SUM_aVF = 130  # sum/integral of QRS complex in lead aVF
    POS_QRS_I = 131  # QRS complex is net positive in lead I
    POS_QRS_aVF = 132  # QRS complex is net positive in lead aVF
    NORM_AXIS = 133  # normal axis
    LAD = 134  # left axis deviation
    RAD = 135  # right axis deviation


def keys_to_vector(keys: list[str] | pd.Series, enum_type: Diagnosis | Feature) -> torch.Tensor:
    vector = torch.zeros(len(enum_type), dtype=torch.float32)
    for label in keys:
