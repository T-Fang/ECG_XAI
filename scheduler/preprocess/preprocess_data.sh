...
script_location='/home/ftian/storage/projects/ECG_XAI/src/scripts/preprocess/preprocess_data.py'
...
function submit_job {
    ...
    job_path="/home/ftian/storage/projects/ECG_XAI/logs/scheduler/preprocess/${name}/"
    mkdir -p ${job_path}
